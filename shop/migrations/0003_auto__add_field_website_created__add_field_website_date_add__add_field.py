...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Website.created'
        db.add_column('shop_website', 'created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Website.date_add'
        db.add_column('shop_website', 'date_add',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.date_mod'
        db.add_column('shop_website', 'date_mod',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Website.created'
        db.delete_column('shop_website', 'created')

        # Deleting field 'Website.date_add'
        db.delete_column('shop_website', 'date_add')

        # Deleting field 'Website.date_mod'
        db.delete_column('shop_website', 'date_mod')
